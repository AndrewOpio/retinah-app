...
//showing more text for a given post
 renderViewMore = (onPress) =>{
   return (
     <Text style = {{color : "#ff33cc", fontSize : 12, width :80}} onPress = {onPress}>view more..</Text>
   );
 }
...
//showing less text for a given post
 renderViewLess = (onPress) =>{
   return (
     <Text style = {{color : "#ff33cc", fontSize : 12, width : 80}} onPress = {onPress}>view less..</Text>
   );
 }
  ...
  render() {
    ...
    <View style={styles.container}>  
      <SideMenuDrawer ref={(ref) => this._sideMenuDrawer = ref}>
        ...
        <View style = {{borderRadius: 0, borderColor : "#ff33cc", borderWidth : 1, alignItems : "center", marginTop : 5,  marginLeft : 5, marginRight : 5}}><Text style = {{color : "#a6a6a6", fontStyle : "italic"}}>News Feeds</Text></View>
            ...
            return (
                  ...
                  <View style = {{width : "100%"}}>
                   <View style ={{flexDirection : "row"}}>
                    <View style = {{flexDirection : "row", marginBottom : 6}}>
                      <Image source = {item.posted_by == "police" ? require('../Resources/police.png') : require('../Resources/logo.png')} style ={{width : 40, height : 40, borderRadius : 20, borderWidth : 1, borderColor : "#999999"}}/>
                      <View>
                        <Text style = {{ fontSize : 18, marginLeft : 6}}>{item.posted_by == "police" ? "Police" : "Retinah"}</Text>
                        <View style = {styles.timeContainer}>
                          <Icon name = "globe" size = {12} style = {{marginTop : 1, marginLeft : 5}}/>
              ...
              <View style = {styles.cardFooter}>
                <View style = {styles.socialBarContainer}>
                  ...
                  {this.state.user == "pol" || this.state.user == "ret" ? <View style = {styles.socialBarSection}>            
                    <TouchableHighlight underlayColor = "#e6e6e6" style = {styles.socialBarButton} onPress = {()=> this.deletepost(item.id)}>
                      <View style = {{flexDirection : "row"}}>
                  ...
                  {this.state.user == "pol" ?<View style = {styles.socialBarSection}>            
                    <TouchableHighlight underlayColor = "#e6e6e6" style = {styles.socialBarButton} onPress = {()=> this.editepot(item.id)}>
                      <View style = {{flexDirection : "row"}}>
   ...
   />}
  {this.state.user == "retinah" || this.state.user == "police"  ?  <Floating/> : this.state.user == "citizen" ? <Float/> : <View></View> }
  </SideMenuDrawer>
  </View>
    );
  }
